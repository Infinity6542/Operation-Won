    ...
    group('Model Integration Tests', () {
      test('should handle complex data structures', () {
        ...
        final complexEventJson = {
          ...
          'event_description': 'Multi-day training exercise for emergency response protocols including communication procedures, evacuation routes, and coordination with local authorities.',
          'is_organiser': true,
        };

        expect(() => AuthResponse.fromJson(complexAuthJson), returnsNormally);
        expect(() => ChannelResponse.fromJson(complexChannelJson), returnsNormally);
      ...
      test('should maintain data integrity through serialization', () {
        ...
        expect(deserializedEvent.eventDescription, originalEvent.eventDescription);
      ...
      test('should handle malformed JSON gracefully', () {
        ...
        for (final json in malformedJsons) {
          expect(() => ChannelResponse.fromJson(Map<String, dynamic>.from(json)), returnsNormally);
          expect(() => EventResponse.fromJson(Map<String, dynamic>.from(json)), returnsNormally);
          expect(() => AuthResponse.fromJson(Map<String, dynamic>.from(json)), returnsNormally);
        }
      });
    });
    ...
    group('Model Edge Cases', () {
      test('should handle Unicode characters', () {
        final unicodeRequest = EventRequest(
          ...
          eventDescription: 'Training with Unicode: français, español, 中文, العربية',
        );
