...
class _HomeViewState extends State<HomeView>
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text('Status: ${authProvider.isLoggedIn ? "Logged in" : "Not logged in"}'),
          ],
        ),
        actions: [
          TextButton(
  ...
  Widget _buildConnectionDot(ThemeData theme, bool isConnected) {
    final color = isConnected ? theme.colorScheme.secondary : theme.colorScheme.error;
    return Container(
      width: 8,
      height: 8,
      decoration: BoxDecoration(
  ...
  Widget _buildTabBar(ThemeData theme) {
    return Container(
      ...
      child: TabBar(
        ...
        onTap: (index) {
          // Close FAB if it's expanded when switching tabs
          if (_isFabExpanded) {
            _closeFab();
          }
        },
  ...
  Widget _buildEventsTab(BuildContext context, EventProvider eventProvider) {
    ...
    if (eventProvider.events.isEmpty) {
      return _buildEmptyState(
        ...
        title: 'No Events Yet',
        subtitle: 'Create your first event to get started with team coordination',
  ...
  Widget _buildChannelsTab(BuildContext context, ChannelProvider channelProvider) {
  ...
  Widget _buildSpeedDial(ThemeData theme) {
    return Stack(
      ...
      children: [
        ...
        // Speed Dial Items (Event and Channel)
        AnimatedBuilder(
              ...
              children: [
                ...
                Transform.scale(
                  ...
                  child: Transform.translate(
                    offset: Offset(0, -70 * _fabAnimation.value),
                    child: Opacity(
                ...
                Transform.scale(
                  scale: _fabAnimation.value,
                  child: Transform.translate(
                    offset: Offset(0, -10 * _fabAnimation.value),
                    child: Opacity(
                      opacity: _fabAnimation.value,
                      child: _buildSpeedDialItem(
                        theme: theme,
                ...
                FloatingActionButton(
                  ...
                  child: AnimatedRotation(
                    ...
                    child: Icon(_isFabExpanded ? LucideIcons.x : LucideIcons.plus),
                  ),
                ),
              ],
            );
  ...
  Widget _buildSettingsItem({
    ...
    final titleColor = isDestructive ? theme.colorScheme.error : theme.colorScheme.onSurface;
